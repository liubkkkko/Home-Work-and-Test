...
//розрахунок кількості корму на один кілограм для собак//розрахунок кількості корму на один кілограм для собак//розрахунок кількості корму на один кілограм для собак//розрахунок кількості корму на один кілограм для собак//розрахунок кількості корму на один кілограм для собак//розрахунок кількості корму на один кілограм для собак
//розрахунок кількості корму на один кілограм для собак
//розрахунок кількості корму на один кілограм для собак
//розрахунок кількості корму на один кілограм для собак
//розрахунок кількості корму на один кілограм для собак
